       ...
       <!-- main -->
        ...
        <div class="template-customer">
          ...
          <h1>Đăng ký tài khoản</h1>
           <?php if(isset($_GET['notifi']) && $_GET['notifi'] == "error"):   ?>
            <h1 style="color: #FF0000;text-align: center;">ĐĂNG KÍ THẤT BẠI</h1>

           <?php elseif(isset($_GET['notifi']) && $_GET['notifi'] == "success"):   ?>
            <h1 style="color: #FF0000;text-align: center;">ĐĂNG KÍ THÀNH CÔNG</h1>
          <?php else: ?>
